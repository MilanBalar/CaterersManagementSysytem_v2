...
<html>
<head>
<title> Home Page :: CaterersManagementSystem </title>
...
<body>
 <div class="header">
	...
	<!-- start search-->	
		<div class="banner">
			<p class="animated wow fadeInLeft" data-wow-duration="1000ms" data-wow-delay="500ms">Here you can get different different caterers varieties of foods...</p>
			<label></label>
			<h4 class="animated wow fadeInTop" data-wow-duration="1000ms" data-wow-delay="500ms">Hello And Welcome Caterers Managemet System</h4>
