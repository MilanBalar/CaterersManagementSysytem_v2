...
public class AdminController {
	...
	@RequestMapping("/addCaterersForm")
	public String addCaterersFormMethod(HttpSession session,@ModelAttribute("userInfo") TblAppUser userData) {
		/*----------- user restriction for page access------------------*/
		TblAppUser current_user=(TblAppUser)session.getAttribute("user");
		if(current_user==null){
		   	session.setAttribute("message", "You are not logged in !! Login first");
